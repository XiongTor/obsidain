...
for i in $tt; do 
  ...
  # echo -e "$name $prop_mapping/$mapping" >> mapping/total_final_outgroup3_result.txt
done

sed -i '1i species properly_paired/mapped' mapping/total_final_outgroup3_result.txt
